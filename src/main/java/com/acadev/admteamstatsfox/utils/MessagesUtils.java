package com.acadev.admteamstatsfox.utils;

public class MessagesUtils {
	public static final String LIST_OF_PLAYERS = "Lista de jugadores encontrados.";
	public static final String LIST_OF_PLAYERS_ACTIVES = "Lista de jugadores activos encontrados.";
	...
	public static final String TOURNMENT_UPDATED = "Torneo modificado.";
