...
public class FunctionsUtils {
	...
	public static LocalDateTime generateLocalDateTimeFromLocalDateAndTimeString(LocalDate localDate,
			String timeString) {
	...
	public static Integer calculateOurGoals(List<GoalRequest> goalsRequest) {
		Integer goalsOurCount = (int) goalsRequest.stream().filter(c -> c.getOur()).count();
